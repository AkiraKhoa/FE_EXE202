...
import EditUserModal from "./EditUserModal"; // Import modal vào component
...
const UsersTable = () => {
  ...
  return (
    ...
    >
      ...
      {editUserId && <EditUserModal userId={editUserId} onClose={() => setEditUserId(null)} onSave={handleSave} />}
    </motion.div>
  );
};
